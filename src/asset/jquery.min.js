...
(function (a, b) {
  function cy(a) {
    ...
    if (f.isArray(b)) f.each(b, function (b, e) {
      c || bE.test(a) ? d(a, e) : ca(a + "[" + ((typeof e === "undefined" ? "undefined" : babelHelpers.typeof(e)) == "object" || f.isArray(e) ? b : "") + "]", e, c, d);
    });else if (!c && b != null && (typeof b === "undefined" ? "undefined" : babelHelpers.typeof(b)) == "object") for (var e in b) {
      ca(a + "[" + e + "]", b[e], c, d);
    } else d(a, b);
  }function b_(a, c) {
    var d,
    ...
    function J() {
      ...
      var a,
          ...
          j = 1,
          k = arguments.length,
          l = !1;typeof i == "boolean" && (l = i, i = arguments[1] || {}, j = 2), (typeof i === "undefined" ? "undefined" : babelHelpers.typeof(i)) != "object" && !e.isFunction(i) && (i = {}), k === j && (i = this, --j);for (; j < k; j++) {
        ...
        return a && (typeof a === "undefined" ? "undefined" : babelHelpers.typeof(a)) == "object" && "setInterval" in a;
        ...
        var i = a.length;if ((typeof c === "undefined" ? "undefined" : babelHelpers.typeof(c)) == "object") {
          for (var j in c) {
    ...
    var b,
      ...
      if (!!f.acceptData(a)) {
        var g,
            ...
            m = l ? f.cache : a,
            n = l ? a[j] : a[j] && j,
            o = c === "events";if ((!n || !m[n] || !o && !e && !m[n].data) && k && d === b) return;n || (l ? a[j] = n = ++f.uuid : n = j), m[n] || (m[n] = {}, l || (m[n].toJSON = f.noop));if ((typeof c === "undefined" ? "undefined" : babelHelpers.typeof(c)) == "object" || typeof c == "function") e ? m[n] = f.extend(m[n], c) : m[n].data = f.extend(m[n].data, c);g = h = m[n], e || (h.data || (h.data = {}), h = h.data), d !== b && (h[f.camelCase(c)] = d);if (o && !h[c]) return g.events;k ? (i = h[c], i == null && (i = h[f.camelCase(c)])) : i = h;return i;
      }
      ...
      }if ((typeof a === "undefined" ? "undefined" : babelHelpers.typeof(a)) == "object") return this.each(function () {
        f.data(this, a);
      ...
      var c = typeof a === "undefined" ? "undefined" : babelHelpers.typeof(a),
  ...
  f.event = { add: function add(a, c, d, e, g) {
      ...
      if (!e || e.nodeType !== 3 && e.nodeType !== 8) {
        var h = c.type || c,
            ...
            q,
            r,
            s;if (E.test(h + f.event.triggered)) return;h.indexOf("!") >= 0 && (h = h.slice(0, -1), k = !0), h.indexOf(".") >= 0 && (i = h.split("."), h = i.shift(), i.sort());if ((!e || f.event.customEvent[h]) && !f.event.global[h]) return;c = (typeof c === "undefined" ? "undefined" : babelHelpers.typeof(c)) == "object" ? c[f.expando] ? c : new f.Event(h, c) : new f.Event(h), c.type = h, c.isTrigger = !0, c.exclusive = k, c.namespace = i.join("."), c.namespace_re = c.namespace ? new RegExp("(^|\\.)" + i.join("\\.(?:.*\\.)?") + "(\\.|$)") : null, o = h.indexOf(":") < 0 ? "on" + h : "";if (!e) {
    ...
    var d = 0,
      ...
      var h, i;if ((typeof a === "undefined" ? "undefined" : babelHelpers.typeof(a)) == "object") {
      ...
      }if ((typeof a === "undefined" ? "undefined" : babelHelpers.typeof(a)) == "object") {
        for (var g in a) {
          this.off(g, c, a[g]);
        }return this;
    ...
    f.fn[a] = function (c, d) {
      ...
      });if ((typeof a === "undefined" ? "undefined" : babelHelpers.typeof(a)) != "object" && a !== b) return this.empty().append((this[0] && this[0].ownerDocument || c).createTextNode(a));return f.text(this);
    ...
    if (arguments.length === 2 && c === b) return this;return f.access(this, a, c, !0, function (a, c, d) {
      ...
      if (!!a && a.nodeType !== 3 && a.nodeType !== 8 && !!a.style) {
        ...
        }h = typeof d === "undefined" ? "undefined" : babelHelpers.typeof(d), h === "string" && (g = bv.exec(d)) && (d = +(g[1] + 1) * +g[2] + parseFloat(f.css(a, c)), h = "number");if (d == null || h === "number" && isNaN(d)) return;h === "number" && !f.cssNumber[i] && (d += "px");if (!k || !("set" in k) || (d = k.set(a, d)) !== b) try {
          j[c] = d;
        } catch (l) {}
      }
    ...
    bV = c.createElement("a"), bV.href = "", bV = bV.href;
      ...
      }var h = "GET";c && (f.isFunction(c) ? (d = c, c = b) : (typeof c === "undefined" ? "undefined" : babelHelpers.typeof(c)) == "object" && (c = f.param(c, f.ajaxSettings.traditional), h = "POST"));var i = this;f.ajax({ url: a, type: h, dataType: "html", data: c, complete: function complete(a, b, c) {
    ...
    f[c] = function (a, d, e, g) {
      ...
      }(typeof a === "undefined" ? "undefined" : babelHelpers.typeof(a)) == "object" && (c = a, a = b), c = c || {};var d = f.ajaxSetup({}, c),
          e = d.context || d,
    ...
    f.fn[a] = function (a, c, d) {
      ...
      var d = a && (typeof a === "undefined" ? "undefined" : babelHelpers.typeof(a)) == "object" ? f.extend({}, a) : { complete: c || !c && b || f.isFunction(a) && a, duration: a, easing: c && b || b && !f.isFunction(b) && b };d.duration = f.fx.off ? 0 : typeof d.duration == "number" ? d.duration : d.duration in f.fx.speeds ? f.fx.speeds[d.duration] : f.fx.speeds._default;if (d.queue == null || d.queue === !0) d.queue = "fx";d.old = d.complete, d.complete = function (a) {
